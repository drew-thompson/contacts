...
import { ContactsState, contactsAdapter, initialState } from './contacts.reducer';
...
describe('Contacts Selectors', () => {
  ...
  beforeEach(() => {
    state = {
      contacts: contactsAdapter.addAll(
        [createContactsEntity('PRODUCT-AAA'), createContactsEntity('PRODUCT-BBB'), createContactsEntity('PRODUCT-CCC')],
        {
          ...initialState,
